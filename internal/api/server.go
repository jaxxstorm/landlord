...
func (s *Server) registerRoutes() {
	...
	s.router.Get("/api/swagger.json", s.handleSwaggerSpec)
	s.router.Get("/api/docs", s.handleDocsUI)

	// Compute config routes
	s.router.Get("/api/compute/config", s.handleComputeConfigDiscovery)

	// Tenant routes
	s.router.Post("/api/tenants", s.handleCreateTenant)
	s.router.Get("/api/tenants", s.handleListTenants)
	s.router.Get("/api/tenants/{id}", s.handleGetTenant)
	s.router.Put("/api/tenants/{id}", s.handleUpdateTenant)
	s.router.Post("/api/tenants/{id}/archive", s.handleArchiveTenant)
	s.router.Delete("/api/tenants/{id}", s.handleDeleteTenant)
}
