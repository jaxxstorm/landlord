	...
	tests := []struct {
	...
	}{
		{
			...
			tenant: &Tenant{
				...
				DesiredConfig: map[string]interface{}{"image": "app:v1"},
				ObservedConfig: map[string]interface{}{"image": "app:v2"},
			},
			want: false,
		},
		{
			...
			tenant: &Tenant{
				...
				Status:        StatusReady,
				DesiredConfig: map[string]interface{}{"image": "app:v1"},
				ObservedConfig: map[string]interface{}{"image": "app:v1"},
			},
			want: false,
		},
		{
			...
			tenant: &Tenant{
				ID:            uuid.New(),
				Status:        StatusReady,
				DesiredConfig: map[string]interface{}{"image": "app:v2"},
				ObservedConfig: map[string]interface{}{"image": "app:v1"},
			},
			want: true,
		},
